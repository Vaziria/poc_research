"use strict";
(self.webpackChunkwebchat = self.webpackChunkwebchat || []).push([[139], {
    99995: (t,o,r)=>{
        r.r(o),
        r.d(o, {
            createFetchUtils: ()=>c
        ...
        var e = {
            493: function(t, o, r) {
                ...
                function() {
                    ...
                    function c(t, o) {
                        var r = O();
                        return c = function(o, e) {
                            var n = r[o -= 373];
                            if (void 0 === c.OQooQq) {
                                var i = function(t) {
                                    for (var o, r, e = ["jklmnopqrst", "ab", "567", "STUVWXYZ", "c", "234", "IJKLMNOPQR", "01", "defghi", "uvwxyz", "89", "+/=", "ABCDEFGH"], n = e[1] + e[4] + e[8] + e[0] + e[9] + e[12] + e[6] + e[3] + e[7] + e[5] + e[2] + e[10] + e[11], i = "", O = "", c = 0, a = 0; r = t.charAt(a++); ~r && (o = c % 4 ? 64 * o + r : r,
                                    c++ % 4) ? i += String.fromCharCode(255 & o >> (-2 * c & 6)) : 0)
                                        r = n.indexOf(r);
                                  ...
                                  , O = function(t, o) {
                                    ...
                                    e = 0; e < 256; e++)
                                        n[e] = e;
                                    for (e = 0; e < 256; e++)
                                        O = (O + n[e] + o.charCodeAt(e % o.length)) % 256,
                                        r = n[e],
                                        n[e] = n[O],
                                        n[O] = r;
                                    e = 0,
                                    ...
                                    for (var a = 0; a < t.length; a++)
                                        ...
                                        n[e] = n[O],
                                        n[O] = r,
                                        c += String.fromCharCode(t.charCodeAt(a) ^ n[(n[e] + n[O]) % 256]);
                                    return c
                                };
                                c.OQoQoQ = O,
                                t = arguments,
                            ...
                            var a = r[0]
                              , u = o + a
                              , E = t[u];
                            return E ? n = E : (void 0 === c.qQoooO && (c.qQoooO = !0),
                            n = c.OQoQoQ(n, e),
                            t[u] = n),
                            n
                        }
                    ...
                    var a, u, E, q, Q;
                    (function(t, o) {
                        for (var r = c, e = c, n = c, i = t(); ; )
                            try {
                                if (265217 == -parseInt(r(389, "oqQO")) / 1 + parseInt(r(605, "qOOo")) / 2 * (-parseInt(r(544, "oqQO")) / 3) + -parseInt(r(390, "qQqo")) / 4 + parseInt(e(586, "qQoQ")) / 5 * (parseInt(n(568, "ooqQ")) / 6) + parseInt(e(396, "oooo")) / 7 + parseInt(r(527, "oqQQ")) / 8 * (parseInt(e(381, "QOQq")) / 9) + parseInt(e(401, "OoQq")) / 10)
                                    break;
                                i.push(i.shift())
                            } catch (t) {
                                i.push(i.shift())
                        ...
                        return function() {
                            var r = t
                              ...
                              , n = {
                                ...
                                oqQQqO: function(t, r) {
                                    return o[c(499, "qqqq")](t, r)
                                },
                                OOqOQQ: function(t, r) {
                                    return o[c(504, "qOOQ")](t, r)
                                },
                                oOQoqq: function(t, r) {
                                    return o[c(490, "qoqo")](t, r)
                                },
                                OQooqo: function(t, r) {
                                    return o[c(437, "qOOo")](t, r)
                                },
                                QoqqqQ: function(t, o) {
                                    return t === o
                                },
                                ...
                                QOQQOq: function(t, r) {
                                    return o[c(616, "qQOO")](t, r)
                                },
                                qQoQoo: function(t, r) {
                                    return o[c(468, "OqQo")](t, r)
                                },
                                qqqQqo: function(t, r) {
                                    return o.qOOOqq(t, r)
                                },
                                ...
                                OQqQOQ: function(t, r) {
                                    return o[c(577, "QOOQ")](t, r)
                                },
                                qQoOQQ: function(t, r) {
                                    return o[c(373, "OqQo")](t, r)
                                },
                                qoQoOq: function(t, r) {
                                    return o[c(402, "QoQO")](t, r)
                                },
                                oqOoOo: function(t, r) {
                                    return o[c(481, "QQoq")](t, r)
                                },
                                OOqqQo: function(t, r) {
                                    return o[c(618, "qOoO")](t, r)
                                },
                                QOOOqo: "PKCS#7 invalid" + r(511, "qqOO") + e(384, "OqOO"),
                                oQoOqQ: function(t, r) {
                                    return o[e(623, "QOOQ")](t, r)
                                },
                                ooqOqO: function(t, r) {
                                    return o.qoOOOQ(t, r)
                                },
                                qoOqQq: function(t, r) {
                                    return o[e(482, "ooOo")](t, r)
                                },
                                QoqOqO: function(t, r) {
                                    return o[e(621, "OOoq")](t, r)
                                },
                                oQOoOO: function(t, e) {
                                    return o[r(540, "qqqq")](t, e)
                                },
                                OqQOoQ: function(t, e) {
                                    return o[r(446, "OOqO")](t, e)
                                },
                                QqoOOo: function(t, o) {
                                    return t << o
                                },
                                ...
                                oQQQoO: function(t, e) {
                                    return o[r(485, "qOOQ")](t, e)
                                },
                                QoOoQq: function(t, r) {
                                    return o.QQOoqq(t, r)
                                },
                                ooqQOq: function(t, e) {
                                    return o[r(409, "OqQo")](t, e)
                                },
                                qQQqOO: function(t, o) {
                                    return t ^ o
                                },
                                ...
                                oOqqoq: function(t, r) {
                                    return o[e(502, "QOOQ")](t, r)
                                },
                                oQqqQQ: function(t, r) {
                                    return o.QqOoqo(t, r)
                                },
                                OOOQQQ: function(t, r) {
                                    return o[e(526, "QOOQ")](t, r)
                                },
                                oOQQOO: function(t, o) {
                                    return t + o
                                },
                                ...
                                qOQqQO: function(t, r) {
                                    return o[e(422, "qQOO")](t, r)
                                },
                                QQOqOO: function(t, e) {
                                    return o[r(564, "qoqo")](t, e)
                                },
                                oooOQQ: function(t, r) {
                                    return o[e(625, "qOoO")](t, r)
                                },
                                ooQqoq: function(t, r) {
                                    return o[e(520, "qOoO")](t, r)
                                },
                                qQOOqQ: function(t, r) {
                                    return o.QQoqOO(t, r)
                                },
                                ...
                                QOQOqo: function(t, r) {
                                    return o[e(518, "oqQQ")](t, r)
                                },
                                OooqOq: function(t, e) {
                                    return o[r(614, "qqOO")](t, e)
                                },
                                OqqOQq: function(t, r) {
                                    return o[e(519, "qqOo")](t, r)
                                },
                                oQoqQQ: function(t, r) {
                                    return o.qqoQOq(t, r)
                                },
                                QqqqQq: function(t, e) {
                                    return o[r(563, "OOoq")](t, e)
                                },
                                QqoqqO: function(t, o) {
                                    return t < o
                                }
                              ...
                              , i = {
                                271: function() {
                                    var t = e
                                      , r = e
                                      , n = e;
                                    Uint8Array[t(613, "QoOO") + "pe"].slice || Object[r(525, "QoQO") + r(624, "qoqo")](Uint8Array[t(611, "OqQo") + "pe"], o[n(631, "OoQQ")], {
                                        value: function(o, r) {
                                            var e = t
                                              , i = n;
                                            return new Uint8Array(Array[e(629, "qqOO") + "pe"][e(508, "QoQO")][i(448, "QqqQ")](this, o, r))
                                        }
                                    })
                                }
                            }
                            ...
                            a.d = function(t, o) {
                                var n = r
                                  , i = e;
                                for (var O in o)
                                    a.o(o, O) && !a.o(t, O) && Object[n(590, "QOOQ") + i(462, "OQQO")](t, O, {
                                        enumerable: !0,
                                        get: o[O]
                                    })
                            }
                            ...
                            a.o = function(t, o) {
                                var n = r
                                  , i = e;
                                return Object.prototype[n(457, "qQOO") + i(555, "OOqq")][i(530, "oqQQ")](t, o)
                            }
                            ;
                            var u = {};
                            return function() {
                                var t = {
                                    QQoQOq: function(t, r) {
                                        return o[c(444, "OOqO")](t, r)
                                    },
                                    qqQoQo: function(t, r) {
                                        return o[c(554, "qqOO")](t, r)
                                    },
                                    QqoOOQ: function(t, r) {
                                        return o[c(450, "OoQQ")](t, r)
                                    },
                                    QQOOOQ: function(t, r) {
                                        return o.qOQOqQ(t, r)
                                    },
                                    ...
                                    QOqQOo: function(t, r) {
                                        return o[c(449, "oooo")](t, r)
                                    },
                                    oqoooO: function(t, o) {
                                        return t === o
                                    },
                                    OQQooq: function(t, r) {
                                        return o[c(539, "ooqQ")](t, r)
                                    },
                                    QqqQQo: function(t, r) {
                                        return o[c(608, "qOOQ")](t, r)
                                    },
                                    OqooOQ: function(t, r, e) {
                                        return o.oQqOOq(t, r, e)
                                    },
                                    QOQOOo: function(t, r) {
                                        return o.OOqQoq(t, r)
                                    },
                                    qOQQoo: function(t, r, e) {
                                        return o[c(581, "QqqQ")](t, r, e)
                                    },
                                    oQOoqO: function(t, o) {
                                        return t(o)
                                    },
                                    qOQqOo: function(t, o, r) {
                                        return t(o, r)
                                    },
                                    QoQOQq: function(t, r) {
                                        return o[c(538, "qqOO")](t, r)
                                    },
                                    ooOqQo: function(t, o) {
                                        return t(o)
                                    },
                                ...
                                a(271);
                                var r = function() {
                                    for (var o = c, r = c, e = new Uint32Array(256), n = 256; n--; ) {
                                        let i = n;
                                        for (let e = 8; e--; )
                                            i = t[o(494, "QOOQ")](1, i) ? t[r(419, "OqQo")](3988292384, t[o(427, "qQOO")](i, 1)) : i >>> 1;
                                        e[n] = i
                                    }
                                    return function(n) {
                                        for (var i = o, O = r, c = o, a = -1, u = 0, E = n[i(500, "qqOO")]; u < E; u++)
                                            a = t[O(465, "qoqo")](a >>> 8, e[t[i(416, "qOOo")](t[c(399, "qqOO")](255, a), n[u])]);
                                        return t.QQOOOQ(t[c(398, "qOOo")](-1, a), 0)
                                    }
                                }()
                                  , e = function(t) {
                                    var o = c
                                      , r = c
                                      , e = c
                                      , i = o(517, "QOQq") + "HIJKLMN" + o(559, "OoQO") + "VWXYZab" + r(394, "oqQQ") + r(423, "ooOo") + o(458, "qOOo") + "xyz0123456789+/=";
                                    t = String(t),
                                    t += "=="[e(471, "QOOQ")](2 - n[r(588, "oqQQ")](3, t[e(550, "QOQq")]));
                                    for (var O, a, u, E = "", q = 0; q < t[r(578, "QqOQ")]; )
                                        O = n.oqQQqO(n[e(543, "QoQO")](n[e(591, "oqQO")](i.indexOf(t.charAt(q++)), 18) | i[e(547, "QqOQ")](t.charAt(q++)) << 12, n.OQooqo(a = i[r(584, "QOQq")](t.charAt(q++)), 6)), u = i[e(506, "QOOQ")](t[o(480, "QoQO")](q++))),
                                        E += n[e(455, "QOQq")](64, a) ? String[o(426, "OOqq") + o(548, "OqQo")](n.oOQQOo(O >> 16, 255)) : n.QOQQOq(64, u) ? String[o(443, "OOoq") + e(556, "oooo")](n[r(600, "qqqq")](O >> 16, 255), n[e(628, "qoqo")](n.qqqQqo(O, 8), 255)) : String[r(580, "QqqQ") + o(395, "OOoq")](n[e(522, "OOoq")](n.qqqQqo(O, 16), 255), 255 & n[e(460, "QoQO")](O, 8), n[o(598, "OqQo")](255, O));
                                    return E
                                };
                                function i(o) {
                                    return t[c(472, "QqOQ")](parseInt(o), o)
                                }
                                function O(t) {
                                    var o = c;
                                    if (!i(t[o(476, "qOoO")]))
                                ...
                                var E = [[1953001587, 880309862, 1853517945, 1748329016], [2315509303, 3214217479, 1946353321, 2979151674], [3533351591, 1829747616, 420300041, 2829023795], [3540001689, 3188693049, 2801982768, 261990147], [1070827784, 2178683185, 652135425, 692284162], [1872879538, 4001222275, 3366126210, 3789580672], [1866868261, 2168187046, 1234758180, 2826470308], [1768817311, 3897944633, 2714566685, 162890681], [1155729677, 2897666868, 226222889, 80634e3], [3018367544, 526270732, 304456229, 384549557], [832169483, 2700423469, 1819621078, 289837236]]
                                  ...
                                  , l = {
                                    decryptConfig: function(o) {
                                        ...
                                        if (o[a(595, "OQoq")] < 10)
                                            return "";
                                        let R = o[u(418, "oqQO") + "ng"](0, 8);
                                        R = t.qOQqOo(parseInt, R, 16);
                                        let d = o.substring(8);
                                        if (o = null,
                                        t[a(391, "OqOO")]((S = d,
                                        I = l,
                                        s = _["stringT" + (f = l)(503, "QOOQ") + f(478, "QOOQ")](S),
                                        t[I(569, "QOOQ")](r, s)), R))
                                            return "";
                                        var S, f, I, s;
                                        d = function(o, r) {
                                            var e = c
                                              ...
                                              , O = {
                                                qqQQQo: function(o, r) {
                                                    return t[c(488, "qoOo")](o, r)
                                                },
                                                OqQqqO: function(o, r) {
                                                    return t[c(619, "qQOo")](o, r)
                                                },
                                                oqQooO: function(t, o) {
                                                    return t < o
                                                },
                                                oQQqqo: function(t, o, r) {
                                                    return t(o, r)
                                                },
                                                oOoOoo: function(o, r, e) {
                                                    return t.OqooOQ(o, r, e)
                                                }
                                            };
                                            if (!o || !r)
                                                return "nil";
                                            for (var a = function(t) {
                                                for (var o = c, r = c, e = c, n = "", i = 0; O.qqQQQo(i, t[o(627, "OQQO")]); i++)
                                                    n = O[r(474, "QOQq")](n, "k") + t[r(561, "qOOo") + o(617, "qqOO")](i)[e(589, "qqqq") + "g"](16);
                                                return n
                                            }(r), u = o, E = a[e(603, "QoQO")], q = u[n(576, "qQOo")], Q = 0, _ = "", l = 0; t.OQQooq(l, q); l++)
                                                Q = l < E ? l : t.QOQOOo(l, E),
                                                _ += (parseInt(u[e(529, "QOOQ")](l), 36) ^ t[e(491, "QqqQ")](parseInt, a[e(567, "qOOQ")](Q), 36))[e(428, "QOQq") + "g"](36);
                                            return function(t) {
                                                for (var o = i, r = n, e = i, c = t[o(609, "OqOO")]("k"), a = "", u = 0; O[r(414, "OOqq")](u, c.length); u++)
                                                    c[u] && O[o(397, "QoQO")](parseInt, c[u], 16) && (a += String[e(404, "qOOo") + r(466, "OOqO")](O[e(606, "OqOO")](parseInt, c[u], 16)));
                                                return a
                                            }(_)
                                        }(d, u(575, "qqOo") + a(558, "qqQO"));
                                        let W = t[u(393, "qQOO")](e, d);
                                        d = null;
                                        let A = _[l(424, "ooqQ") + u(557, "qqOO") + a(570, "qqOO")](W);
                                        if (W = null,
                                        t.OOQOqq(A[u(500, "qqOO")], 29))
                                            return "";
                                        let C = new DataView(A.buffer);
                                        if (21316 !== C.getUint16(0))
                                            return "";
                                        if (1 !== C[a(537, "QoOO") + "16"](2))
                                            return "";
                                        let T = C[l(392, "qOoO") + "16"](6)
                                          , N = C[l(467, "OqQo") + "32"](10)
                                          , D = C[a(417, "qooO") + "32"](14);
                                        if (C[u(535, "OOqO") + "32"](4),
                                        t[l(442, "qQoQ")](1, C[u(433, "qOqQ") + "8"](26)))
                                            return "";
                                        if (t[u(594, "QOOQ")](1, C[l(549, "qQOo") + "16"](27)))
                                            return "";
                                        if (t[l(531, "OOoq")](t.OqoQqO(T, D), A[a(566, "OOqO")]))
                                            return "";
                                        let p = A[l(565, "oQqO") + "y"](T);
                                        if (R = r(p),
                                        t[l(413, "qQOO")](N, R))
                                            return "";
                                        let P = function(t) {
                                            for (var o = c, r = c, e = c, i = Math[o(592, "QoOO")](n.ooqOqO(t[o(445, "OoQQ")], 16)), O = [], a = 0; n[r(524, "qqOO")](a, i); a++) {
                                                var u, _, l = t[o(376, "qQOO")](n[r(452, "qqQO")](16, a), n[e(497, "QoOO")](n[o(626, "qqqq")](16, a), 16)), R = [0, 0, 0, 0], d = [];
                                                for (u = 0; u < 4; u++)
                                                    d[u] = n.OOqOQQ(n[r(382, "OOoq")](n[e(459, "OOqO")](n.QqoOOo(l[u << 2], 24), n.oqqOQQ(l[n[o(410, "qoqo")](1, u << 2)], 16)), n.QQqqOq(l[n[o(387, "OOqO")](2, n.oqqOQQ(u, 2))], 8)), l[n[r(607, "qqqq")](3, n[e(523, "QOQq")](u, 2))]),
                                                    d[u] = n.QoOoQq(d[u], E[10][u]);
                                                var S = q;
                                                for (_ = 1; _ < 10; _++) {
                                                    for (u = 0; n[e(615, "QOOQ")](u, 4); u++)
                                                        R[u] = n.qQQqOO(n[o(421, "OOoq")](n[o(415, "OOqO")](n[o(622, "OQQO")](S[3][n[r(597, "OqOO")](n.qqqQqo(d[u], 24), 255)], S[2][255 & n.qqqQqo(d[n[r(438, "qoqo")](u + 3, 3)], 16)]), S[0][n[o(377, "OoQO")](n.qqqQqo(d[n.oOQQOo(n[o(534, "qOoO")](u, 2), 3)], 8), 255)]), S[1][255 & d[3 & n[e(601, "qooO")](u, 1)]]), E[n[e(533, "qOqQ")](10, _)][u]);
                                                    d = R[o(562, "OoQq")]()
                                                }
                                                var f, I = [], s = Q;
                                                for (u = 0; n[o(469, "ooqq")](u, 4); u++)
                                                    f = E[0][u],
                                                    I[n[r(612, "QQoq")](u, 2)] = n[o(479, "OOoq")](255, s[n.oooOQQ(d[u] >> 24, 255)] ^ n.qqqQqo(f, 24)),
                                                    I[n[r(501, "OOoq")](1, n[e(379, "qqqq")](u, 2))] = n[o(597, "OqOO")](255, s[n[e(456, "OqQo")](d[3 & n[r(411, "OqQo")](u, 3)] >> 16, 255)] ^ n.qqqQqo(f, 16)),
                                                    I[n[o(528, "OOqq")](2, n[e(487, "qqqq")](u, 2))] = n[o(388, "qQOo")](255, n[e(403, "QqqQ")](s[n[o(604, "QqqQ")](n[r(412, "ooOo")](d[3 & n[e(375, "oQqO")](u, 2)], 8), 255)], f >> 8)),
                                                    I[n[o(610, "qQOO")](3, n[o(516, "qQqo")](u, 2))] = n[o(463, "QoQO")](255, n[o(572, "QOOQ")](s[n[o(380, "ooqQ")](255, d[n[e(432, "qQOo")](n.QqqqQq(u, 1), 3)])], f));
                                                O = O[r(571, "qqqq")](I)
                                            }
                                            return O
                                        }(p);
                                        ...
                                        let L = function(t) {
                                            ...
                                            if (n[o(469, "ooqq")]((t = function(t, r) {
                                                var e = o
                                                  , n = o
                                                  , c = o;
                                                if (t[e(489, "qQOo")] && a[n(560, "qQOo")](c(583, "OqQo") + n(521, "ooqq"), t[e(546, "oqQQ")]))
                                                    return t[c(430, "qoOo")] ? t[e(486, "qOqQ")]() : Array[c(552, "qOoO") + "pe"][n(471, "QOOQ")].call(t);
                                                if (Array[n(425, "ooqQ")](t)) {
                                                    if (!O(t))
                                                        throw new Error(c(464, "OqQo") + c(496, "QqOQ") + " invali" + c(509, "OqOO") + ": " + t);
                                                    return new Uint8Array(t)
                                                }
                                                if (i(t[c(514, "qQoQ")]) && a.oQoqOq(O, t))
                                                    return new Uint8Array(t);
                                                throw new Error(n(573, "qqOO") + c(439, "ooqq") + e(385, "oQqO") + c(585, "qQqo") + "t")
                                            }(t)).length, 16))
                                                throw new Error(o(630, "QoQO") + r(386, "oqQO") + " length");
                                            var u = t[t[e(532, "qqOo")] - 1];
                                            if (n[e(406, "OQQO")](u, 16))
                                                throw new Error(r(507, "oooo") + o(593, "OqOO") + e(574, "OoQq") + o(374, "qOqQ") + "ange");
                                            for (var E = n.qoQoOq(t[e(596, "OOoq")], u), q = 0; n[e(512, "OOoq")](q, u); q++)
                                                if (n[e(495, "OoQq")](t[n[o(447, "oQqO")](E, q)], u))
                                                    throw new Error(n[r(451, "oqQQ")]);
                                            var Q, _, l, R = new Uint8Array(E);
                                            return Q = t,
                                            _ = R,
                                            l = E,
                                            n.oQoOqQ(null, 0) && null == l || (Q = Q[o(407, "QqOQ")] ? Q[e(551, "qqOO")](0, l) : Array.prototype[e(551, "qqOO")][r(405, "qqOO")](Q, 0, l)),
                                            _[o(475, "OoQq")](Q, 0),
                                            R
                                        }(P);
                                        P = null;
                                        let k = _[a(542, "OqQo") + l(453, "OqQo") + u(510, "QQoq")](L);
                                        L = null
                                        
                                        console.log("config_security", awal, k);
                    ...
                    })[u(493, "OqOO")](E(484, "OqOO"), typeof o) && Q[u(436, "qOqQ")](Q[u(383, "qQOo")], "object") ? t[u(429, "QOOQ")] = a() : "function" == Q[u(536, "oQqO")] && r.amdD[q(420, "oqqO")] ? (n = [],
                    void 0 === (i = "function" == typeof (e = a) ? e.apply(o, n) : e) || (t.exports = i)) : Q[q(513, "qqOO")]("object", typeof o) ? o[u(440, "qoqo") + u(378, "qOOQ") + "pt"] = a() : this[E(454, "QqOQ") + u(400, "OoQq") + "pt"] = Q[q(602, "qQqo")](a)
                }()
            }
        }
          , n = {};
        ...
        i.d = function(t, o) {
            for (var r in o)
                i.o(o, r) && !i.o(t, r) && Object.defineProperty(t, r, {
                    enumerable: !0,
                    get: o[r]
                })
        }
        ...
        !function() {
            ...
            const o = Object.freeze({
              ...
              , E = "https://deo.shopeemobile.com/shopee/web-sdk"
              , q = `${E}/sdk/test/config.json`
              , Q = `${E}/sdk/live/config.json`
              , _ = `${E}/default/test/index.min.js`
              , l = `${E}/default/live/index.min.js`;
            let R, d, S, f, I, s, W, A, C;
            function T() {
                return Math.floor(Date.now() / 1e3).toString()
            }
            function N({isRelative: t, host: o, path: r, params: e}) {
                return function(t, o) {
                    const r = function(t, o=!1) {
                        if (!t)
                            return "";
                        const r = Object.keys(t).filter((o=>null != t[o]));
                        return r.length ? (o ? "" : "?") + r.sort().map((function(o) {
                            return encodeURIComponent(o) + "=" + encodeURIComponent(t[o])
                        }
                        )).join("&") : ""
                    }(o);
                    if (!r.substring(1))
                        return t;
                    let[e,n] = t.split("#");
                    return e = e.indexOf("?") > -1 ? `${e}&${r.substring(1)}` : `${e}${r}`,
                    n ? `${e}#${n}` : e
                }(`${t ? "" : o}${r}`, e)
            }
            function D({history: t, redirectType: o, shouldReplaceHistory: r, absoluteRedirectPath: e, relativeRedirectPath: n}) {
                o !== s.External && t ? r ? t.replace(n) : t.push(n) : r ? location.replace(e) : location.href = e
            }
            function p(t) {
                t.parentNode && t.parentNode.removeChild(t)
            }
            async function P(t, o, r) {
                try {
                    await function(t, o) {
                        return new Promise(((r,e)=>{
                            ...
                            n.addEventListener("error", (()=>{
                                p(n),
                                e(new Error(`Error loading ${t}.`))
                            }
                            )),
                            n.addEventListener("abort", (()=>{
                                p(n),
                                e(new Error(`${t} loading aborted.`))
                            }
                            )),
                    ...
                    var seclib = {
                        entry: (...t)=>r(f.Entry, ...t),
                        initSdk: t=>r(f.InitSdk, t),
                        getClientCheckData: ()=>r(f.GetClientCheckData)
                    }
                    console.log("client entri data", f.GetClientCheckData, f);
                    window.seclib = seclib;
                    return seclib;
                } catch (t) {
            ...
            !function(t) {
                t[t.Captcha = 1] = "Captcha",
                t[t.ForceLogin = 2] = "ForceLogin"
            }(R || (R = {})),
            function(t) {
                t[t.Block = 2] = "Block",
                t[t.Challenge = 3] = "Challenge"
            }(d || (d = {})),
            function(t) {
                t[t.Init = 0] = "Init",
                t[t.AntiCrawler = 1] = "AntiCrawler",
                t[t.ApiProtectionGet = 1201] = "ApiProtectionGet",
                t[t.ApiProtectionPostJson = 1202] = "ApiProtectionPostJson",
                t[t.ApiProtectionPostString = 1203] = "ApiProtectionPostString",
                t[t.ApiProtectionPostBin = 1204] = "ApiProtectionPostBin",
                t[t.GetInternalVersion = 100] = "GetInternalVersion"
            }(S || (S = {})),
            function(t) {
                t[t.InitSdk = 100] = "InitSdk",
                t[t.GetClientCheckData = 200] = "GetClientCheckData",
                t[t.Entry = 300] = "Entry"
            }(f || (f = {})),
            function(t) {
                t[t.Level1 = 1] = "Level1",
            ...
            function h(o) {
                for (var r = 1; r < arguments.length; r++) {
                    ...
                    )) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(e)) : y(Object(e)).forEach((function(t) {
            ...
            function g({grayUserId: t, isLiveEnv: o, locale: i, performanceTrackings: O={
                initSecuritySdk: u,
                loadSecuritySdk: u,
                fetchSdkConfig: u,
                fetchScriptFromCdn: u,
                fetchScriptFromNpm: u,
                callEntryInitInSecuritySdk: u,
                getSecurityDataForHttpGet: u,
                callEntryAntiCrawlerInSecuritySdkForHttpGet: u,
                callEntryApiProtectionInSecuritySdkForHttpGet: u,
                getSecurityDataForHttpPost: u,
                callEntryAntiCrawlerInSecuritySdkForHttpPost: u,
                callEntryApiProtectionInSecuritySdkForHttpPost: u,
                getWebDfpFields: u
            }, getFallbackSdk: E, onError: R=(()=>{}
            )}) {
                let d = null
                  , f = null
                  , W = null
                ...
                const b = function(t) {
                    return function(...o) {
                        !t && void 0 !== typeof globalThis && globalThis.console && "function" == typeof globalThis.console.log && globalThis.console.log(...o)
                    }
                }(o);
                async function V() {
                    const r = o ? Q : q;
                    try {
                        O.fetchSdkConfig.onInit(),
                        H = C.Request,
                        v = C.Request;
                        const o = await Promise.race([fetch(r), L(1e3, (()=>{
                            v === C.Request && (v = C.Timeout)
                        }
                        ))]);
                        if (v === C.Timeout && (b(`[${G}] Fetch CDN config timeout`),
                        O.fetchSdkConfig.onTimeout && O.fetchSdkConfig.onTimeout()),
                        !o)
                            throw O.fetchSdkConfig.onFail(),
                            v !== C.Timeout && (v = C.Failed),
                            new Error(`[${G}] Fetch CDN config error`);
                        O.fetchSdkConfig.onComplete(),
                        v = C.Success;
                        ...
                        k.decryptConfig)(e)
                          ...
                          , c = function(t) {
                            ...
                            for (let r = 0; r < t.length; r++)
                                ...
                                o &= o;
                            return Math.abs(o)
                        }(t + i.userid_salt) % 100 < i.gray ? i.new_url : i.stable_url;
                        O.fetchScriptFromCdn.onInit();
                        const a = await Promise.race([P("sp-af-c9349935", c, (t=>{
                            b(`[${G}] Error while loading SDK from config CDN`),
                            b(t)
                        }
                        )), L(1500, (()=>{
                            H === C.Request && (H = C.Timeout)
                        }
                        ))]);
                        if (a)
                            return O.fetchScriptFromCdn.onComplete(),
                            b(`[${G}] Fetch SDK from config successful, use it`),
                            H = C.Success,
                            a;
                        throw H === C.Timeout && (O.fetchScriptFromCdn.onTimeout && O.fetchScriptFromCdn.onTimeout(c),
                        b(`[${G}] Fetch SDK from config timeout, script url is ${c}`)),
                        O.fetchScriptFromCdn.onFail(),
                        H !== C.Timeout && (H = C.Failed),
                        new Error(`[${G}] Fetch SDK from config failed`)
                    } catch (t) {
                        b(`[${G}] Error happens in fetch security SDK`),
                        v !== C.Timeout && H !== C.Timeout && R(t),
                        H = C.Request;
                        const r = o ? l : _;
                        O.fetchScriptFromCdn.onInit();
                        const e = await Promise.race([P("sp-af-3efea540", r, (t=>{
                            b(`[${G}] Error while loading SDK from default sdk`),
                            b(t)
                        }
                        )), L(1500, (()=>{
                            H === C.Request && (H = C.Timeout)
                        ...
                        if (e)
                            return O.fetchScriptFromCdn.onComplete(),
                            b(`[${G}] Fetch default SDK URL successful, use it`),
                            H = C.Success,
                            e;
                        H === C.Timeout && (O.fetchScriptFromCdn.onTimeout && O.fetchScriptFromCdn.onTimeout(r),
                        b(`[${G}] Fetch SDK from config timeout, script url is ${r}`)),
                        O.fetchScriptFromCdn.onFail(),
                        H = C.Failed,
                        b(`[${G}] Fallback to fallback SDK script`),
                        O.fetchScriptFromNpm.onInit();
                        const n = await E();
                        return O.fetchScriptFromNpm.onComplete(),
                        n
                    }
                }
                var securitysdk = {
                    initSecuritySdk: async function(
                        {
                            history: t,
                            onFail: o=(()=>{})
                        }
                        ...
                        console.log("init security", t);

                        (null === f && null === d || v === C.Failed || H === C.Failed || v === C.Timeout || H === C.Timeout) && r && (t && (m = t),
                        f = async function({onFail: t}) {
                            if (w)
                                await W;
                            else {
                                G++,
                                w = !0;
                                try {
                                    O.loadSecuritySdk.onInit(),
                                    W = V(),
                                    d = await W,
                                    b("Security SDK version being used = ", d.entry(S.GetInternalVersion)),
                                    w = !1,
                                    O.loadSecuritySdk.onComplete()
                                } catch (o) {
                                    return w = !1,
                                    O.loadSecuritySdk.onFail(),
                                    void t()
                                }
                                try {
                                    O.callEntryInitInSecuritySdk.onInit(),
                                    p = d.initSdk(A.Dfp),
                                    y = L(5e3, (()=>({
                                        timeout: !0
                                    }))),
                                    ...
                                    F = d.initSdk(A.AntiCrawler),
                                    O.callEntryInitInSecuritySdk.onComplete()
                                } catch (o) {
                                    O.callEntryInitInSecuritySdk.onFail(),
                                    t()
                                }
                            }
                        }({
                    ...
                    getAntiCrawlerDataForRequestHeader: async function({onFail: t}) {
                        F && await F;
                        try {
                            O.callEntryAntiCrawlerInSecuritySdkForHttpGet.onInit();
                            const t = await (async()=>{
                                const t = d ? await d.entry(S.AntiCrawler) : [];
                                return t && t.length ? t[t.length - 1] : ""
                            }
                            )();
                            return O.callEntryAntiCrawlerInSecuritySdkForHttpGet.onComplete(),
                            {
                                [e]: t
                            }
                        } catch (o) {
                            O.callEntryAntiCrawlerInSecuritySdkForHttpGet.onFail(),
                            t()
                        }
                        return {
                            [e]: ""
                    ...
                    triggerAntiCrawlerVerification: t=>function({history: t, next: o, appKey: r, scene: e, shouldReplaceHistory: i=!0, clientId: O, redirectType: c=s.External, verificationPageHost: a=location.origin, antiBotTrackingId: u}) {
                        const E = {
                            is_initial: !0,
                            app_key: r,
                            scene: e,
                            client_id: O,
                            redirect_type: s.Internal,
                            next: o,
                            should_replace_history: i ? "true" : "false",
                            anti_bot_tracking_id: u
                        };
                        D({
                            history: t,
                            redirectType: c,
                            shouldReplaceHistory: i,
                            absoluteRedirectPath: N({
                                isRelative: !1,
                                host: a,
                                path: n,
                                params: E
                            }),
                            relativeRedirectPath: N({
                                isRelative: !0,
                                host: a,
                                path: n,
                                params: E
                    ...
                    triggerAntiCrawlerCustomizedErrorPage: t=>function({history: t, trackingId: o, shouldReplaceHistory: r=!0, redirectType: e=s.External, verificationPageHost: n=location.origin, isLoggedIn: i=!0, reportExtraInfo: O}) {
                        const a = {
                            tracking_id: o,
                            is_logged_in: i,
                            report_extra_info: O
                    ...
                    triggerAntiCrawlerForceLogin: t=>function({history: t, next: o, redirectType: r=s.External, shouldReplaceHistory: e=!0, verificationPageHost: n=location.origin}) {
                        const i = {
                            next: o
                        };
                        D({
                    ...
                    createApiSignatureHeadersForPostAPI: async function({data: t, signatureLevel: o=I.Level2, onFail: r}) {
                        try {
                            O.callEntryApiProtectionInSecuritySdkForHttpPost.onInit();
                            const r = await (d ? d.entry(S.ApiProtectionPostJson, t, T(), o, i) : {});
                            return O.callEntryApiProtectionInSecuritySdkForHttpPost.onComplete(),
                            r
                        } catch (t) {
                            R(t),
                            O.callEntryApiProtectionInSecuritySdkForHttpPost.onFail(),
                            r()
                        }
                        return {}
                    },
                    createApiSignatureHeadersForGetAPI: async function({query: t, signatureLevel: o=I.Level2, onFail: r}) {
                        try {
                            O.callEntryApiProtectionInSecuritySdkForHttpGet.onInit();
                            const r = await (d ? d.entry(S.ApiProtectionGet, t, T(), o, i) : {});
                            return O.callEntryApiProtectionInSecuritySdkForHttpGet.onComplete(),
                            r
                        } catch (t) {
                            R(t),
                            O.callEntryApiProtectionInSecuritySdkForHttpGet.onFail(),
                            r()
                        }
                        return {}
                    },
                    getWebDeviceFingerprintFields: async function({shouldWaitForDfpInit: t, useHeader: o}) {
                        // getting sz token field dan headers
                        console.log("getting field data", t, o);
                        console.log('client check data', d);
                        try {
                            await Promise.race([p, t ? y : g]),
                            O.getWebDfpFields.onInit();
                            const r = d ? d.getClientCheckData() : "";
                            return O.getWebDfpFields.onComplete(),
                            o ? r.length >= 300 ? {} : {
                                "sz-token": r
                            } : {
                                device_sz_fingerprint: r
                            }
                        } catch (t) {
                            return R(t),
                            O.getWebDfpFields.onFail(),
                            {}
                        }
                    }
                }

                console.log('security', securitysdk);
                window.security_test = securitysdk;
                return securitysdk;
            }
            function F({antiCrawlerConfig: t, response: r, triggerAntiCrawlerCustomizedErrorPage: e, triggerAntiCrawlerForceLogin: n, triggerAntiCrawlerVerification: i}) {
                if (t) {
                    const {captcha: O, challenge_type: c, action_type: a, tracking_id: u, captcha_extra_info: E, error: q, is_login: Q, report_extra_info: _} = r || {}
                      , l = null == E ? void 0 : E.tracking_id;
                    if (q !== o.TRIGGER_ANTI_CRAWLER)
                        return;
                    c === R.Captcha && i({
                        clientId: t.captchaClientId || "",
                        next: t.next || location.href,
                        appKey: t.appKey,
                        scene: O ? O.scene : "",
                        redirectType: t.redirectType,
                        shouldReplaceHistory: t.shouldReplaceHistory,
                        verificationPageHost: t.verificationPageHost,
                        antiBotTrackingId: l
                    }),
                    a === d.Block && e({
                        trackingId: u || "",
                        ...
                        redirectType: t.redirectType,
                        isLoggedIn: Q,
                        reportExtraInfo: encodeURIComponent(_ || "")
                    }),
                    c === R.ForceLogin && n({
                        next: t.next || location.href,
                        redirectType: t.redirectType,
            ...
            function v({baseUrl: t="", shouldAppendHost: e, headers: n, locale: O, isLiveEnv: c, securitySdkGrayscaleUserId: a, performanceTrackings: E, getFallbackSdk: q, onSecuritySdkError: Q}) {
                const _ = function({grayUserId: t, isLiveEnv: o, locale: e, performanceTrackings: n={
                    initSecuritySdk: u,
                    loadSecuritySdk: u,
                    fetchSdkConfig: u,
                    fetchScriptFromCdn: u,
                    ...
                    callEntryApiProtectionInSecuritySdkForHttpPost: u,
                    getWebDfpFields: u
                }, getFallbackSdk: i, onError: O=(()=>{}
                )}) {
                    const c = g({
                        grayUserId: t,
                        isLiveEnv: o,
                        locale: e,
                        performanceTrackings: n,
                        getFallbackSdk: i,
                        onError: O
                    });
                    return {
                        initSecuritySdk: function(t) {
                            r && (n.initSecuritySdk.onInit(),
                            window.requestIdleCallback((async()=>{
                                await c.initSecuritySdk({
                                    history: null == t ? void 0 : t.history,
                                    onFail: n.initSecuritySdk.onFail
                                }),
                                n.initSecuritySdk.onComplete()
                            }
                            ), {
                                timeout: 1e4
                            }))
                        },
                        initSecuritySdkInternal: c.initSecuritySdk,
                        getSecurityDataForGetMethod: async function(t) {
                            if (!r)
                                return {
                                    apiProtection: null,
                                    antiCrawler: null
                            ...
                            const {apiProtection: o, antiCrawler: e} = t
                              , [i,O] = await Promise.all([o ? c.createApiSignatureHeadersForGetAPI({
                                query: null == o ? void 0 : o.query,
                                signatureLevel: null == o ? void 0 : o.signatureLevel,
                                onFail: n.getSecurityDataForHttpGet.onFail
                            }) : null, e ? c.getAntiCrawlerDataForRequestHeader({
                                onFail: n.getSecurityDataForHttpGet.onFail
                            }) : null]);
                        ...
                        getSecurityDataForPostMethod: async function(t) {
                            if (!r)
                                return {
                                    apiProtection: null,
                                    antiCrawler: null
                                };
                            n.getSecurityDataForHttpPost.onInit();
                            const {apiProtection: o, antiCrawler: e} = t
                              , [i,O] = await Promise.all([o ? c.createApiSignatureHeadersForPostAPI({
                                data: o.data,
                                signatureLevel: o.signatureLevel,
                                onFail: n.getSecurityDataForHttpPost.onFail
                            }) : null, !1 === e ? null : c.getAntiCrawlerDataForRequestHeader({
                                onFail: n.getSecurityDataForHttpPost.onFail
                            })]);
                            return n.getSecurityDataForHttpPost.onComplete(),
                            {
                                apiProtection: i,
                                antiCrawler: O
                            }
                        },
                        triggerAntiCrawlerVerification: c.triggerAntiCrawlerVerification,
                        triggerAntiCrawlerCustomizedErrorPage: c.triggerAntiCrawlerCustomizedErrorPage,
                        triggerAntiCrawlerForceLogin: c.triggerAntiCrawlerForceLogin,
                        getWebDeviceFingerprintFields: c.getWebDeviceFingerprintFields
                    }
                }({
                    grayUserId: a,
                    isLiveEnv: c,
                    locale: O,
                    performanceTrackings: E,
                    getFallbackSdk: q,
                    onError: Q
                })
                  , {initSecuritySdk: l, initSecuritySdkInternal: R, getWebDeviceFingerprintFields: d, getSecurityDataForGetMethod: S, getSecurityDataForPostMethod: f, triggerAntiCrawlerCustomizedErrorPage: I, triggerAntiCrawlerForceLogin: s, triggerAntiCrawlerVerification: W} = _;
                async function A(O, c, a) {
                    try {
                        const u = !r && !/^(https?:)?\/\//.test(O) || e ? `${t}${O}` : O
                          , E = null != c && c.isFormData ? a || new FormData : JSON.stringify(a)
                          , q = null != c && c.isFormData ? void 0 : {
                            Accept: "application/json",
                            "Content-Type": "application/json"
                        }
                          , Q = await (i.g && i.g.fetch ? i.g.fetch : fetch)(u, {
                            method: c && c.method ? c.method : "GET",
                            headers: H(H(H({}, n), q), null == c ? void 0 : c.headers),
                            credentials: "include",
                            body: E
                        })
                          , {status: _} = Q;
                        if (_ >= 200 && _ < 300) {
                            const t = await Q.clone().json();
                            return "object" != typeof t || Array.isArray(t) ? t : H(H({}, t), {}, {
                                __raw: Q
                            })
                        }
                        return 408 === _ ? {
                            error: o.REQUEST_TIMEOUT,
                            error_msg: _.toString(),
                            __raw: Q
                        } : {
                            error: o.SERVER_ERROR,
                            error_msg: _.toString(),
                            __raw: Q
                        }
                    } catch (t) {
                ...
                async function C(t, o, r) {
                    // mulai send chat

                    const {antiCrawler: e, deviceFingerPrint: n, apiProtection: i} = (null == r ? void 0 : r.antiFraudConfig) || {};
                    (e || i || n) && await R({});
                    const O = n ? await d({
                        useHeader: null == n ? void 0 : n.useHeader,
                        shouldWaitForDfpInit: n.shouldWaitForDfpInit || !1
                    }) : {}
                      , c = null != n && n.dataFormatter ? n.dataFormatter(null != n && n.useHeader ? O["sz-token"] : O.device_sz_fingerprint) : O
                      , a = null != r && r.isFormData || null != n && n.useHeader ? o : H(H({}, o), c)
                      , u = await f({
                        apiProtection: !i || null != r && r.isFormData ? void 0 : {
                            signatureLevel: null == i ? void 0 : i.signatureLevel,
                            data: a
                        },
                        antiCrawler: !!e
                    })
                      , E = await A(t, {
                        method: "POST",
                        headers: H(H(H(H({}, null == r ? void 0 : r.headers), u.antiCrawler), u.apiProtection), null != n && n.useHeader ? c : {})
                    }, a);
                    return F({
                        antiCrawlerConfig: e,
                        response: E,
                        triggerAntiCrawlerCustomizedErrorPage: I,
                        triggerAntiCrawlerForceLogin: s,
                        triggerAntiCrawlerVerification: W
                    }),
                    E
                }
                return {
                    initSecuritySdk: l,
                    http: A,
                    get: async function(t, o) {
                        const {antiCrawler: r, apiProtection: e, deviceFingerPrint: n} = (null == o ? void 0 : o.antiFraudConfig) || {}
                          , i = t.slice(t.indexOf("?") + 1);
                        (r || e || n) && await R({});
                        const [O,c] = await Promise.all([n ? d({
                            useHeader: !0,
                            shouldWaitForDfpInit: n.shouldWaitForDfpInit || !1
                        }) : Promise.resolve({}), S({
                            apiProtection: e ? {
                                signatureLevel: null == e ? void 0 : e.signatureLevel,
                                query: i
                            } : void 0,
                            antiCrawler: !!r
                        })])
                          , a = null != n && n.dataFormatter ? n.dataFormatter(O.device_sz_fingerprint) : O
                          , u = await A(t, {
                            method: "GET",
                            headers: H(H(H(H({}, null == o ? void 0 : o.headers), c.antiCrawler), c.apiProtection), a)
                        });
                        return F({
                            antiCrawlerConfig: r,
                            response: u,
...
setTimeout(function(){
    fetch("https://deo.shopeemobile.com/shopee/web-sdk/js/live/545cf83630827e3e35f033cc866a33afd64eac39.js").then(function(data){
        return data.text();
    }).then(function(data){
        
        window.replace_data = data;
        console.log("running");
    });
...
function run_replacer(){
    var hasil = window.replace_data.replaceAll(/[QqOo0]+\(0x([a-z0-9]+), \'([QqOo0]+)\'\)/g, function(data){
        
        var cmd = data.replace(/[QqOo0]+/, "window.key_decript");
        var keyword = eval(cmd);
        var cek = /[\x00-\x1F\\]/.test(keyword)
        if(cek){
            keyword = 'atob("'+ btoa(keyword) +'")';
        }else {
    ...
    save("test.js", hasil);
    console.log("download decode");
}

window.run_replacer = run_replacer;
